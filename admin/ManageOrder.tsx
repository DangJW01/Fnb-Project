    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.orderItem}>
          ...
          <Text style={[styles.tableHeader, { flex: 2 }]}>Amt</Text>
          <Text style={[styles.tableHeader, { flex: 2 }]}>Order Status</Text>
          <Text style={[styles.tableHeader, { flex: 3 }]}>Delivery Status</Text>
        ...
        {orders.map((item) => (
          <View key={item.orderId} style={styles.orderItem}>
            ...
            <Text style={{ flex: 3, fontSize: 11 }}>{item.orderStatus}</Text>
            <Text style={{ flex: 3, fontSize: 11 }}>{item.deliveryStatus}</Text>
            ...
            >
              <Text style={{ fontSize: 10 }}>Manage</Text>
            </TouchableOpacity>
          </View>
        ))}
      </ScrollView>
